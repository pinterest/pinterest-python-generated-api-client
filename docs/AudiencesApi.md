...
[**audiences_insights_category_list**](AudiencesApi.md#audiences_insights_category_list) | **GET** /ad_accounts/{ad_account_id}/insights/audiences/{scope}/{type}/{category_id} | Get category sub-interest
...
with openapi_generated.pinterest_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling AudiencesApi->audiences_insights_category_list: %s\n" % e)
