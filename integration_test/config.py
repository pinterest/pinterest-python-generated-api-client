...
DEBUG = _os.environ.get('DEBUG', False)
PORT = _os.environ.get('PORT', 0)
APP_ID = _os.environ.get('APP_ID', None)
APP_SECRET = _os.environ.get('APP_SECRET', None)
...
REFRESH_ACCESS_TOKEN = _os.environ.get('REFRESH_ACCESS_TOKEN', None)
API_URI = _os.environ.get('API_URI', 'https://api-latest.pinterest.com/v5')
