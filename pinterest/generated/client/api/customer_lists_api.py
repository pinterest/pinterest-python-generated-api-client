...
class CustomerListsApi(object):
    ...
    def customer_lists_get(
        ...
        **kwargs
        ...
        <strong>This endpoint is currently in beta and not available to all apps. <a href='/docs/features/ads-management/'>Learn more</a>.</strong> <p/> Gets a specific customer list given the customer list ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def customer_lists_update(
        ...
        **kwargs
        ...
        """Update customer lists  # noqa: E501
