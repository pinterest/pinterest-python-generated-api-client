...
class OrderLinesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.order_lines_get_endpoint = _Endpoint(
            settings={
                'response_type': (OrderLineSingleResponse,),
                'auth': [
                    'pinterest_oauth2'
                ],
        ...
        self.order_lines_list_endpoint = _Endpoint(
            settings={
                'response_type': (OrderLinesArrayResponse,),
                'auth': [
                    'pinterest_oauth2'
                ],
    ...
    def order_lines_get(
        ...
        **kwargs
        ...
        <strong>This endpoint is currently in beta and not available to all apps. <a href='/docs/ads/ads-management/'>Learn more</a>.</strong> <p/> Get a specific existing order line associated with an ad account.  # noqa: E501
    ...
    def order_lines_list(
        ...
        **kwargs
        ...
        <strong>This endpoint is currently in beta and not available to all apps. <a href='/docs/ads/ads-management/'>Learn more</a>.</strong> <p/> List existing order lines associated with an ad account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
