...
class ResourcesApi(object):
    ...
    def ad_account_countries_get(
        ...
        **kwargs
        ...
        <strong>This endpoint is currently in beta and not available to all apps. <a href='/docs/features/ads-management/'>Learn more</a>.</strong> <p/> Get Ad Accounts countries  # noqa: E501
